...
<div class="about-container">
    ...
    <section class="hero-section">
        <div class="hero-bg">
            ...
            <!-- Background Image or Piano Visual -->
             <div class="bg-shape"></div>
        </div>
        
        <div class="hero-content" use:observe>
...
<style lang="scss">
    ...
    .hero-bg {
        ...
        // Placeholder for the piano shape in Figma
        .bg-shape {
            position: absolute;
            top: 50%; left: 50%;
    ...
    .vision-content-wrapper {
        @include container;
        display: flex;
        flex-direction: column-reverse; // Mobile first: Text below image or customized logic
        gap: 3rem;
    ...
    .timeline-container {
        ...
        position: relative;
        max-width: 800px;
        padding-left: 2rem; // Space for line on mobile
    ...
    .timeline-line {
        position: absolute;
        left: 2rem; // Matches padding-left
        top: 0;
        bottom: 0;
        width: 1px;
        background-color: #000;
    ...
    .timeline-dot {
        position: absolute;
        left: 0; // Relative to item container on mobile? actually left: 2rem (line pos) - half width
        top: 0.5rem;
        width: 12px;
        height: 12px;
        background-color: #000;
        ...
        // Mobile override
        left: 0; // since container has padding-left: 2rem. wait.
        // Let's adjust dot for mobile perfectly
        left: calc(0px - 6px); // - half width
        
        @media (min-width: 768px) {
            left: 50%;
            // transform is already -50%
        }
    }
    ...
    .sponsor-section {
        ...
        // Background Image logic if needed
        .sponsor-bg {
             position: absolute; top: 0; left: 0; width: 100%; height: 100%;
             opacity: 0.3;
